...
| com.example.scratchGame.dto.Symbol Name | Reward Multiplier |
|-------------|-------------------|
| A           | 50                |
| B           | 25                |
| C           | 10                |
...
| com.example.scratchGame.dto.Symbol Name | Action                       |
|-------------|------------------------------|
...
| applied_winning_combinations | Map of com.example.scratchGame.dto.Symbol and List of applied winning combinations  |
